...
export const MessageDetail = () => {
            ...
            <div class="flex flex-col mt-8">
              ...
              <div class="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
                ...
                />
                  ...
                  <div class="ml-2 text-sm font-semibold">{message.sender_profile.full_name}
                  <div className="small">
                    {message.message}
                  ...
                  <div class="flex items-center justify-center ml-auto text-xs text-white bg-red-500 ">
  ...
  <div key={index} className={message.sender === user_id ? "col-start-6 col-end-13 p-3 rounded-lg" : "col-start-1 col-end-8 p-3 rounded-lg"}>
    {message.sender === user_id ? (
      ...
      <div className="flex flex-row items-center">
        <div className="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0">Ad</div>
